...
for archivo in os.listdir(carpeta_pdf):
    if archivo.endswith(".pdf"):
        ...
        # Renombrar el archivo PDF con el nombre del paciente
        if "Nombre no encontrado" not in nombre_paciente:
            nuevo_nombre = f"{nombre_paciente.replace(' ', '_')}.pdf"
            nueva_ruta = os.path.join(carpeta_pdf, nuevo_nombre)
